<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            OrderManage # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            OrderManage
        </v-card-title >
        ...
        <v-card-text>
            ...
            <Number label="CouponNumber" v-model="value.couponNumber" :editMode="editMode"/>
        </v-card-text>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/orderManages'), this.value)
                        } else {
